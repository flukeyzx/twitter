        ...
        <div className="flex flex-col flex-1">
          <div className="flex gap-2 items-center">
            ...
            <dialog id="my_modal_2" className="modal">
              <div className="modal-box bg-[#1e1e1e] rounded-xl max-w-sm">
                {isDeleting ? (
                  ...
                  <>
                    ...
                    <div className="flex gap-4 justify-around mt-2">
                      <button
                        onClick={() => deletePost()}
                        className="btn bg-red-600 px-10 py-2 rounded-lg mt-4"
                      >
                        Confirm
                      </button>

                      <form method="dialog">
                        <button className="btn bg-gray-600 px-12 py-2 rounded-lg mt-4">
                          Close
                        </button>
                      </form>
                    </div>
